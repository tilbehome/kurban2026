...
const Body = z.object({ vekaletAlindi: z.boolean() });
...
export async function PATCH(req: NextRequest, { params }: RouteParams) {
  ...
  await prisma.hisse.update({
    where: { id },
    data: {
      vekaletAlindi: body.vekaletAlindi,
      vekaletTarihi: body.vekaletAlindi ? new Date() : null,
    },
  });
