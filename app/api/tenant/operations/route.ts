...
const Body = z.discriminatedUnion("action", [
  ...
  z.object({ action: z.literal("record-delivery"), id: z.string().min(3), seasonId: z.string().min(3), shareId: z.string().min(3), customerId: z.string().min(3), receiverName: z.string().max(160).optional(), reason: z.string().max(500).optional(), loadingListId: z.string().min(3).optional(), proof: z.object({ id: z.string().min(3), proofType: z.enum(["signature", "photo", "voice", "note"]), storageKey: z.string().max(500).optional(), note: z.string().max(500).optional() }).optional(), debtOverride: z.object({ approvalRequestId: z.string().min(8), reason: z.string().min(8).max(500), storageKey: z.string().max(500).optional() }).optional(), approval: approvalSchema.optional() }),
