...
const Body = z.discriminatedUnion("action", [
  ...
  z.object({ action: z.literal("report"), reportKey: z.enum(["sales-occupancy", "operations-bottleneck", "delivery-cold-storage", "audit-exceptions", "finance-reconciliation", "customer-season-balances", "supplier-purchases", "animal-cost-health", "cash-bank-pos", "fulfillment-progress", "reversals-refunds", "season-comparison", "exception-center"]), filters: z.record(z.string(), z.string().optional()).optional() }),
