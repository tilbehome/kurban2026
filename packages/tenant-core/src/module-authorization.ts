...
export const KURBAN_AUTHORIZATION_MANIFEST: ModuleAuthorizationManifest = {
  ...
  permissions: [
    ...
    { key: "kurban.paddock.manage.organization", description: "Padok ve hayvan yerleşim geçmişini yönetir", riskLevel: "sensitive" },
  ...
  defaultRoleTemplates: [
    { templateKey: "operations-manager", name: "Kurban Operasyon Yöneticisi", functionalArea: "qurban_operations", accessLevel: "MANAGER", permissions: ["kurban.business.manage.organization", "kurban.season.read.organization", "kurban.season.manage.organization", "kurban.customer.read.organization", "kurban.customer.manage.organization", "kurban.supplier.read.organization", "kurban.supplier.manage.organization", "kurban.purchase.manage.organization", "kurban.expense.manage.organization", "kurban.animal.read.organization", "kurban.animal.manage.organization", "kurban.paddock.manage.organization", "kurban.animal-health.manage.assigned_record", "kurban.qurban-queue.manage.operational_period", "kurban.pricing.manage.organization", "kurban.share.read.operational_period", "kurban.share.reserve.operational_period", "kurban.sale.confirm.operational_period", "kurban.sale.cancel.operational_period", "kurban.sale.transfer.operational_period", "kurban.finance.receipt.create.organization", "kurban.finance.ledger.read.organization"].map((key) => allow(key as PermissionKey)) },
